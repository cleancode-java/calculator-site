...
function guestHeader(){
    return `
       <header class="bg-gray-200">
        <section class="bg-white shadow-md shadow-fuchsia-700/20">
            <div class="max-w-7xl mx-auto px-6 py-8
                        flex flex-col gap-6
                        md:flex-row md:items-center md:justify-between">
                <div class="max-w-2xl border-l-4 border-fuchsia-600 pl-4">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Accivell is a simple finance tool built for self-employed professionals who want clarity,
                ...
                <div class="navigation flex items-center gap-4">
                    ...
                    <nav id="mainNav" class="hidden md:block text-sm">
                        <ul class="flex flex-col gap-2 md:flex-row md:flex-wrap">
                            <li><a href="/" class="px-3 py-1.5 text-gray-700 hover:text-fuchsia-700 transition">Home</a></li>
                            <li><a href="why-choose-pro.html" class="px-3 py-1.5 text-gray-700 hover:text-fuchsia-700 transition">Why choose Pro</a></li>
                            <li><a href="how-it-works.html" class="px-3 py-1.5 text-gray-700 hover:text-fuchsia-700 transition">How it works</a></li>
                            <li><a href="contact-us.html" class="px-3 py-1.5 text-gray-700 hover:text-fuchsia-700 transition">Contact us</a></li>
                            <li><a href="login.html" 
                                class="px-3 py-1.5 text-purple-800 font-semibold hover:text-fuchsia-700 transition">
                                Login
                            </a>
                            </li>
                        </ul>
